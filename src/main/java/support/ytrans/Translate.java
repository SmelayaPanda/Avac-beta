 ...
 */
final class Translate extends YandexTranslatorAPI {
     ...
     */
    private static String execute(@SuppressWarnings("SameParameterValue") final String text, @SuppressWarnings("SameParameterValue") final Language from, @SuppressWarnings("SameParameterValue") final Language to) throws Exception {
