...
/**
 * Provides an interface to the Yandex start.Translator Detect service method
 */
final class Detect extends YandexTranslatorAPI {
    ...
    /**
	  ...
	  */
	  private static Language execute(@SuppressWarnings("SameParameterValue") final String text) throws Exception {
    ...
    private static void validateServiceState(final String text) throws Exception {
        ...
        if(byteLength>10240) { // TODO What is the maximum text length allowable for Yandex?
            throw new RuntimeException("TEXT_TOO_LARGE - Yandex start.Translator (Detect) can handle up to 10,240 bytes per request");
        }
