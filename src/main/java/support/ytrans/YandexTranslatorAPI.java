...
abstract class YandexTranslatorAPI {
     ...
     */
    static void setKey(@SuppressWarnings("SameParameterValue") final String pKey) {
        apiKey = pKey;
    }
     ...
     */
    static String retrievePropString(final URL url, @SuppressWarnings("SameParameterValue") final String jsonValProperty) throws Exception {
     ...
     */
    static String retrievePropArrString(final URL url, @SuppressWarnings("SameParameterValue") final String jsonValProperty) throws Exception {
        final String response = retrieveResponse(url);
    ...
    private static String[] jsonArrToStringArr(final String inputString, @SuppressWarnings("SameParameterValue") final String propertyName) {
